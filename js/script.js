 ...
 jQuery(document).ready(function($) {
    ...
    $("html").niceScroll({
      cursorcolor:"#990000", // Set cursor color
  ...
  $('.banner').css('margin-top', (0 - (scrollPosition * .8)) + 'px');
   ...
   $(window).on('scroll', function() {
    ...
    // itemsMobile : false
      ...
      map = new GMaps({
        el: '#map', lat: 42.113631, lng: -80.137428, zoom: 12, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
	  
    map.addMarker({ lat: 42.113631, lng: -80.137428, title: 'BD InfoSys',
